...
def track_objects(video_path, output_path, conf_threshold=0.3, device='cuda'):
    """
    Track objects in video using YOLOv12n model.
    """
    # Load YOLOv12n model
    ...
    print(f"Processing video with YOLOv12n...")
    ...
    print(f"\nFinished processing with YOLOv12n.")
...
def main():
    parser = argparse.ArgumentParser(description='Track objects with YOLOv12n')
    parser.add_argument('--video', type=str, required=True, help='Path to input video')
    parser.add_argument('--output', type=str, default='results/yolov12n_output.mp4', help='Path to output video')
