...
def track_objects(video_path, output_path, conf_threshold=0.3, device='cuda'):
    """
    Track objects in video using YOLOv10n model.
    """
    # Load YOLOv10n model
    ...
    print(f"Processing video with YOLOv10n...")
    ...
    print(f"\nFinished processing with YOLOv10n.")
...
def main():
    parser = argparse.ArgumentParser(description='Track objects with YOLOv10n')
    parser.add_argument('--video', type=str, required=True, help='Path to input video')
    parser.add_argument('--output', type=str, default='results/yolov10n_output.mp4', help='Path to output video')
